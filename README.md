...
<img src="https://readme-typing-svg.demolab.com?font=Poppins&weight=600&size=24&pause=1000&color=3B82F6&center=true&vCenter=true&width=650&lines=Building+Real-World+MERN+Applications;Learning+DSA+%26+System+Design;Open+Source+Learner;Future+Software+Engineer" alt="Typing SVG" />
...
- 🚀 Building projects with production-level architecture
...
|---------|-------------|------|
| 🚀 AI Career Copilot | AI-powered career guidance platform | MERN + AI |
| 💼 Job Portal | Full-stack recruitment platform | MERN |
| 💬 Real-Time Chat App | Socket.IO messaging application | MERN + Socket.io |
| 📊 Expense Tracker | Personal finance management | React + Node |
| 📋 Project Management System | Team collaboration tool | MERN |
